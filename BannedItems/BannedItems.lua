...
-- TODO: Maybe make this configurable.  But IMO uninstalling this script is the easiest way to disable it.
-- local removeBannedItems = false

function BannedItems.Remove(_, pid)
...
customEventHooks.registerHandler("OnPlayerInventory", BannedItems.Remove)
